...
describe('Carousel Displays pictures for a style', () => {
  ...
  test('sets the state of the style after a get request', () => {
      const wrapper = shallow(<CarouselContainer photos={dummyData[1].photos} />)
      let indicators = app.find('CarouselIndicators');
      expect(indicators.prop('thumbnails')).toEqual(thumbDummy)
    }
  )
})
